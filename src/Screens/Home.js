    ...
    return (
      <ScrollView>
        <Container style={{backgroundColor: 'white'}}>
          ...
          <View
            style={{backgroundColor: '#4a2d8b', height: 200, borderRadius: 70}}>
              ...
              <View style={{paddingHorizontal: 20, marginTop: 20}}>
                ...
                <View
                  ...
                  <Text
                    ...
                    {usersdetails && usersdetails.cash}
                  </Text>
                </View>
          ...
          <View style={{paddingHorizontal: 20}}>
            <View style={style.navCard}>
              <View style={{alignItems: 'center', justifyContent: 'center'}}>
                ...
                <Text style={{color: '#4a2d8b', fontFamily: 'Caladea-Regular'}}>
                  Top Up
                </Text>
              </View>
              <View style={{alignItems: 'center', justifyContent: 'center'}}>
          ...
          <View style={{paddingHorizontal: 20}}>
            <View style={styles.Kios}>
              ...
              <View>
                <Div
                  style={{fontSize: 20, fontWeight: 'bold', color: '#F7C738'}}>
                  Kunjungi Kios PayLive
                </Div>
                <Div style={{fontSize: 16, color: '#F7C738'}}>
                  Untuk melanjutkan. Lihat lokasi PayLive
                </Div>
              </View>
              <View>
                <MaterialCommunityIcons
        ...
        <View style={{backgroundColor: 'white'}}>
          ...
          />
          <ScrollView horizontal>
            <CardPromo img={require('../Assets/Images/promo1.jpg')} />
            <CardPromo img={require('../Assets/Images/promo2.jpg')} />
            <CardPromo img={require('../Assets/Images/promo3.jpg')} />
            <CardPromo img={require('../Assets/Images/promo4.jpeg')} />
            <CardPromo img={require('../Assets/Images/promo5.jpg')} />
          </ScrollView>
        </View>
      </ScrollView>
    );
